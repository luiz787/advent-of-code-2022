...
fn main() {
    let fs_disk_space: u64 = 70_000_000;
    ...
    let unused_space = fs_disk_space - root_size;
    let to_delete = needed_space - unused_space;

    let mut large_enough_directories: Vec<_> = sizes
        .iter()
    ...
    println!("{}", large_enough_directories[0]);
}
